...
public class CouponsServiceTest {
    ...
    void testAddCouponSuccess() {
        ...
        CouponsDTO dto = new CouponsDTO(null, "SAVE10", 100.0, LocalDate.now().plusDays(5));
    ...
    void testAddCouponExpired() {
        ...
        CouponsDTO dto = new CouponsDTO(null, "SAVE10", 100.0, LocalDate.now().minusDays(1));
    ...
    void testApplyCouponMaxDiscount() {
        ...
        coupon.setDiscountAmount(1000.0);
        when(repo.findByCouponCode("SAVE10")).thenReturn(Optional.of(coupon));
